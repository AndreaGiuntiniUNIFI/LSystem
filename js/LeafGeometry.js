class LeafGeometry {
    constructor(
      ...
      //draw stem
      vertices.push(new THREE.Vector3(-width_stem / 2, y, current_z));
      vertices.push(new THREE.Vector3(width_stem / 2, y, current_z));
      vertices.push(new THREE.Vector3(-width_stem / 2, -width_stem, current_z));
      vertices.push(new THREE.Vector3(width_stem / 2, -width_stem, current_z));
      current_z += min_length_stem;
      y = this._getVauleOnParabola(curvature, current_z, z_zero, y_zero);
      width_stem -= stem_decrease_value;
      vertices.push(new THREE.Vector3((-width_stem / 2), y, min_length_stem));
      vertices.push(new THREE.Vector3((width_stem / 2), y, min_length_stem));
      vertices.push(new THREE.Vector3((-width_stem / 2), y - width_stem, min_length_stem));
      vertices.push(new THREE.Vector3((width_stem / 2), y - width_stem, min_length_stem));
      ...
      faces.push(new THREE.Face3(2, 4, 0));
      faces.push(new THREE.Face3(1, 5, 3));
      faces.push(new THREE.Face3(4, 2, 6));
      faces.push(new THREE.Face3(5, 7, 3));
      faces.push(new THREE.Face3(5, 4, 6));
      ...
      for (let i = 0; i < n_leaves; i++) {
        ...
        vertices.push(new THREE.Vector3((-width_stem / 2), y, current_z));
        vertices.push(new THREE.Vector3((width_stem / 2), y, current_z));
        vertices.push(new THREE.Vector3((-width_stem / 2), y - width_stem, current_z));
        vertices.push(new THREE.Vector3((width_stem / 2), y - width_stem, current_z));
        faces.push(new THREE.Face3(key_last_vertex - 3, key_last_vertex - 1, key_last_vertex));
        faces.push(new THREE.Face3(key_last_vertex, key_last_vertex - 2, key_last_vertex - 3));
        faces.push(new THREE.Face3(key_last_vertex - 2, key_last_vertex - 3, key_last_vertex + 1));
        faces.push(new THREE.Face3(key_last_vertex + 1, key_last_vertex + 2, key_last_vertex - 2));
        faces.push(new THREE.Face3(key_last_vertex + 1, key_last_vertex + 3, key_last_vertex + 4));
        faces.push(new THREE.Face3(key_last_vertex + 4, key_last_vertex + 2, key_last_vertex + 1));
        faces.push(new THREE.Face3(key_last_vertex - 1, key_last_vertex + 3, key_last_vertex + 4));
        faces.push(new THREE.Face3(key_last_vertex - 1, key_last_vertex, key_last_vertex + 4));
        faces.push(new THREE.Face3(key_last_vertex + 4, key_last_vertex + 3, key_last_vertex - 1));
        key_last_vertex += 4;
        ...
        vertices.push(new THREE.Vector3(
          ...
          z_foglia));
        faces.push(new THREE.Face3(key_last_vertex - 7, key_last_vertex + 1, key_last_vertex - 3));
        faces.push(new THREE.Face3(key_last_vertex + 1, key_last_vertex - 7, key_last_vertex - 5));
        faces.push(new THREE.Face3(key_last_vertex - 1, key_last_vertex - 3, key_last_vertex + 1));
        faces.push(new THREE.Face3(key_last_vertex - 5, key_last_vertex - 1, key_last_vertex + 1));
        key_last_vertex += 1;
        ...
        faces.push(new THREE.Face3(key_last_vertex - 7, key_last_vertex - 3, key_last_vertex + 1));
        faces.push(new THREE.Face3(key_last_vertex - 7, key_last_vertex + 1, key_last_vertex - 5));
        faces.push(new THREE.Face3(key_last_vertex + 1, key_last_vertex - 3, key_last_vertex - 1));
        faces.push(new THREE.Face3(key_last_vertex - 1, key_last_vertex - 5, key_last_vertex + 1));
        key_last_vertex += 1;
